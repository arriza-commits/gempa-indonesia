...
# --- INFO KELOMPOK (SIDEBAR) ---
st.sidebar.markdown("---")
st.sidebar.header("👥 Tim Penyusun")

# Menggunakan Bullet Points agar rapi
st.sidebar.info("""
**Kelompok Geodesi A:**
1. **Nama Anggota 1** (NIM 123456)
2. **Nama Anggota 2** (NIM 234567)
3. **Nama Anggota 3** (NIM 345678)
